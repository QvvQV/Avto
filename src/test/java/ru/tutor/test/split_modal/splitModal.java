...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber5() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud5() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther5() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber6() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud6() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther6() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber7() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
////            System.out.println("name: " + cookie.getName());
////            if (cookie.getName().equals("split-option")) {
////                System.out.println("куки: " + cookie.getValue() + " куки: " + cookies);
////            }
////        }
//
//        wait.until(visibilityOfElementLocated(By.id("email")));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud7() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther7() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber1() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud1() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther1() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber2() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud2() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther2() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber3() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud3() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther3() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Sber")
//    public void ShowModalVersionTestSber() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Cloud")
//    public void ShowModalVersionTestCloud() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
...
//    @Test
//    @DisplayName("Show Modal find click Other")
//    public void ShowModalVersionTestOther() throws InterruptedException {
//        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
//        driver.get(url);
//        Thread.sleep(500);
//        System.out.println(driver.manage().getCookieNamed("split-option"));
